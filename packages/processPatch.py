...
def process_patch(name, DirIn, DirOut, limitNrows=None, calc_seasonal_metrics=None, calc_seas_binned_metrics=None  ):
    ...
    #
    ### at the very beginnig : convert  Flux from erg/cm2/sec/Hz  to Jansky
...
# not needed to use, since we don't want to calculate any 
# metrics  based on magnitudes... 
